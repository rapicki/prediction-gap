...
from src.scripts.calculate_pgi import calculate_pgi_main
from src.scripts.calculate_ranking import calculate_ranking_main
from src.scripts.compare_times import compare_times_main
