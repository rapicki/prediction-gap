...
from src.scripts.python_tree_scripts.calculate_pgi import calculate_pgi_main
from src.scripts.python_tree_scripts.calculate_ranking import calculate_ranking_main
from src.scripts.python_tree_scripts.compare_times import compare_times_main
